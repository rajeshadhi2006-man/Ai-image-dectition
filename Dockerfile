...
# Create uploads directory and history file with correct permissions for HF (UID 1000)
RUN mkdir -p uploads && touch history.json && chmod -R 777 uploads history.json
